...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="<?= base_url('input/export') ?>" class="btn btn-secondary mb-3">Export ke Excel</a>
...
<div class="modal fade" id="detail<?php echo $nomor_tiket; ?>" tabindex="-1" role="dialog" aria-labelledby="detailLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url('input/update') ?>">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="col-xs-8">
                                    <span class="btn btn-secondary"><?= substr($i['tgl_input'], -26, -16); ?> </span>
                                </div>
                            </div>
                            <div class="col">
                                <label class="control-label col-xs-3">Terakhir Update</label>
                                <div class="col-xs-8">
                                    <span class="btn btn-secondary"><?= substr($i['tgl_update'], -26, -16); ?> </span>
                                </div>
                            </div>
                        </div>
                    </div>
